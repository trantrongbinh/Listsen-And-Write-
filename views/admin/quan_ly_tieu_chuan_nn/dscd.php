...
if(isset($_POST['submit1'])){
  ...
  while (list($key, $val) = @each($box)){
    $ketqua = $tcnn1 ->xoaTieuChuanNN1($val);
  }
  ?>
    ...
    <?php
      ...
      ?>
          <tr>
            ...
            <td style="text-align: center;"><i class="fa fa-pencil fa-fw"></i> <a href="?p=edit-cd-tcnn&id-tcnn1=<?=$ds['idc1']?>">Edit</a></td>
...
function them() {
    window.location.assign("?p=them-chu-de-tcnn")
}
</script>