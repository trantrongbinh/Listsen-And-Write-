    ...
    <?php
      ...
      ?>
          <tr>
            ...
            <td style="text-align: center;"><i class="fa fa-pencil fa-fw"></i> <a href="?p=edit-cd-vbqppl&id-vbqppl1=<?=$ds['idc1']?>">Edit</a></td>
...
function them() {
    window.location.assign("?p=them-chu-de-vbqppl")
}
</script>