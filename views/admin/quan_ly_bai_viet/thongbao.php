...
<div style="width:600px; height:120px;margin: 15px 10px 10px 10px;"> 
  <label style="margin-left:10px;"> Tieu De: </label>  
  <input type="text" name="tieude" value="" style="width:480px; height:24px;margin-bottom:5px;">
  <br>
  <label> Noi Dung: </label>  
  <input type="text" name="noidung" value="" style="width:480px; height:24px;margin-bottom:5px;">
  <br>
...
<div class="kc"></div>
<div style="width:740px; min-height:580px; border-style:groove; border-width:thin;margin-left:10px; margin-top: -40px;"> 
<table>
  <tr>
    <th width="30">STT</th>
    <th width="500">Chu De</th>
    <th width="70">Sửa</th>
    <th width="70">Xem</th>
    <th width="70">Chọn</th>
  </tr>
    ...
    <?php
      ...
      ?>
          <tr>
            ...
            <td style="text-align: center;"><?=$ds['TieuDe']?></td>
            <td style="text-align: center;"><i class="fa fa-pencil fa-fw"></i> <a href="?p=edit-tb&id-tb=<?=$ds['id']?>">Edit</a></td>
            <td style="text-align: center;"><i class="fa fa-pencil fa-fw"></i> <a href="?p=chi-tiet-tb&id-tb=<?=$ds['id']?>">Xem</a></td>
...
function them() {
    window.location.assign("?p=them-tb")
}
</script>