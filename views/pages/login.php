...
//     	echo "<script>  alert('Vui lòng nhập đầy đủ tên đăng nhập và mật khẩu!'); window.history.go(-1);</script>";
...
if(isset($_POST['dangnhap'])){
    ...
    echo "<script>  alert('Sai thông tin đăng nhập!'); window.history.go(-1);</script>";
	}elseif (isset(($_SESSION['user_name']))) {
		if ($_SESSION['per'] == 'quantribaiviet' || $_SESSION['per'] == 'quantrixaydung' || $_SESSION['per'] == 'admin' ) {
			echo "<script> window.location = 'views/admin/admin.php';</script>";
		}elseif ($_SESSION['per'] == 'bandoc'){
